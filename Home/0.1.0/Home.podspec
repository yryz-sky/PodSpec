Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/yryz-sky/Home"
  ...
  s.source       = { :git => "git@github.com:yryz-sky/Home.git", :tag => s.version.to_s }
  ...
  s.resources  = "Home/Home/**/*.{storyboard,xib}", "Home/Assets.xcassets"
